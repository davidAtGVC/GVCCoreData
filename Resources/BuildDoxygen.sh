...
SRC_ROOT=`abspath ${SCRIPT_ROOT}/../GVCCoreData`
OUT_ROOT=$TMPDIR/GVCCoreData
...
echo "load documentation set with path \"/Users/$USER/Library/Developer/Shared/Documentation/DocSets/net.global-village.GVCCoreData.docset\""
